            ...
            <section className="w-full flex flex-col bg-gray4 rounded-t-2xl  py-3 ">
              ...
              <section className="grid grid-cols-7 grid-rows-2 mt-2 gap-1 mb-6 px-4">
                {hours.map((hour, index) => {
                  ...
                  const todayDate = requestDate(); // 오늘 날짜
                  const reserveDate = reserveInfo.reservations.date; // 예약 날짜
                  ...
                  if (todayDate === reserveDate) {
                    ...
                    console.log("지금 시", currentHour); // 이 숫자에서 10 빼기
                    console.log("지금 분", currentMin); // 이 숫자가 만약에 30~59 사이에 있으면...
                  }
