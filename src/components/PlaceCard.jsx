...
import IndicatorSection from "../components/IndicatorSection.jsx";
...
function PlaceCard({ title }) {
  ...
  return (
    <section className="w-full flex flex-col bg-gray4 shadow-md rounded-2xl px-4 py-3 border-[1px] mb-10">
      ...
      >
        <h2 className="medium" style={{ fontSize: "18px", marginTop: "10px" }}>
          예약 현황
        </h2>
        <h2
          className="medium"
